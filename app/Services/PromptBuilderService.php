...
class PromptBuilderService
{
    ...
    {
        return <<<PROMPT
Kamu adalah KARA (Karsa Artificial Response Assistant), asisten AI untuk platform Karsa, sebuah platform yang menghubungkan mahasiswa dengan proyek KKN di berbagai institusi.
