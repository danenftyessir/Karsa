...
@section('title', 'AI Assistant - Karsa')
...
@section('content')
<!-- Hero Section -->
<section class="chatbot-hero flex items-center justify-center text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
        ...
        <h1 class="hero-title-chatbot text-4xl md:text-5xl font-bold mb-4">
            AI Assistant Karsa
        </h1>
        <p class="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto">
            Tanya apapun tentang proyek KKN, dokumentasi, dan panduan di platform Karsa
        </p>
    </div>
</section>
...
<section class="gradient-mesh-bg py-12 min-h-screen">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 flex justify-between items-center">
            ...
            <a href="{{ route('student.chatbot.create') }}" class="inline-flex items-center px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg shadow-md transition-all duration-200 hover:shadow-lg">
        ...
        <div class="empty-state text-center py-16">
            ...
            <p class="text-gray-600 mb-6 max-w-md mx-auto">
                Mulai percakapan baru dengan AI Assistant untuk mendapatkan bantuan tentang proyek KKN dan dokumentasi Karsa
            </p>
            <a href="{{ route('student.chatbot.create') }}" class="inline-flex items-center px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg shadow-md transition-all duration-200 hover:shadow-lg">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
